...
task DetermineGermlineContigPloidyCohortMode {
    ...
    command <<<
        ...
        /home/ml2529/bin/gatk-4.1.7.0/gatk --java-options "-Xmx16000m"  DetermineGermlineContigPloidy \
            ${"-L " + intervals} \
...
task GermlineCNVCallerCohortMode {
    ...
    command <<<
        ...
        /home/ml2529/bin/gatk-4.1.7.0/gatk --java-options "-Xmx60000m"  GermlineCNVCaller \
            --run-mode COHORT \
            -L ${intervals} \
            --input ${sep=" --input " read_count_files} \
